...
int main() {
    ...
    // 9. Разложение на простые звенья
    gnuplot_links << "set terminal pngcairo size 1000,800 enhanced font 'Arial,16'" << endl;
    ...
    gnuplot_links << "set yrange [0:1]" << endl;
    gnuplot_links << "set label 1 at 0.5,0.95 'Разложение передаточной функции на простые звенья' center front font 'Arial-Bold,20'" << endl;
    gnuplot_links << "set label 2 at 0.5,0.85 'Исходная функция:' center front font 'Arial-Bold,18'" << endl;
    gnuplot_links << "set label 3 at 0.5,0.78 'H(s) = {200} / {0.001s^3 + 0.07s^2 + s + 200}' center front font 'Arial,16'" << endl;
    gnuplot_links << "set label 4 at 0.5,0.68 'Разложение на множители:' center front font 'Arial-Bold,18'" << endl;
    gnuplot_links << "set label 5 at 0.5,0.62 'H(s) = 200 × {1} / {0.05s + 1} × (0.02s + 1) × (0.001s + 1) × {1} / {0.0001s + 1}' center front font 'Arial,14'" << endl;
    gnuplot_links << "set label 6 at 0.5,0.52 'Простые звенья:' center front font 'Arial-Bold,18'" << endl;
    gnuplot_links << "set label 7 at 0.1,0.45 '1. Усилительное звено:' font 'Arial-Bold,16'" << endl;
    gnuplot_links << "set label 8 at 0.1,0.40 'K = 200' font 'Arial,14'" << endl;
    gnuplot_links << "set label 9 at 0.1,0.35 'L(ω) = 20lg(200) ≈ 46 дБ' font 'Arial,14'" << endl;
    gnuplot_links << "set label 10 at 0.5,0.45 '2. Апериодическое звено:' font 'Arial-Bold,16'" << endl;
    gnuplot_links << "set label 11 at 0.5,0.40 'W(s) = 1 / (0.05s + 1)' font 'Arial,14'" << endl;
    gnuplot_links << "set label 12 at 0.5,0.35 'ω_{ср} = 1/0.05 = 20 рад/с' font 'Arial,14'" << endl;
    gnuplot_links << "set label 13 at 0.9,0.45 '3. Форсирующее звено:' font 'Arial-Bold,16'" << endl;
    gnuplot_links << "set label 14 at 0.9,0.40 'W(s) = 0.02s + 1' font 'Arial,14'" << endl;
    gnuplot_links << "set label 15 at 0.9,0.35 'ω_{ср} = 1/0.02 = 50 рад/с' font 'Arial,14'" << endl;
    gnuplot_links << "set label 16 at 0.1,0.25 '4. Форсирующее звено:' font 'Arial-Bold,16'" << endl;
    gnuplot_links << "set label 17 at 0.1,0.20 'W(s) = 0.001s + 1' font 'Arial,14'" << endl;
    gnuplot_links << "set label 18 at 0.1,0.15 'ω_{ср} = 1/0.001 = 1000 рад/с' font 'Arial,14'" << endl;
    gnuplot_links << "set label 19 at 0.5,0.25 '5. Апериодическое звено:' font 'Arial-Bold,16'" << endl;
    gnuplot_links << "set label 20 at 0.5,0.20 'W(s) = 1 / (0.0001s + 1)' font 'Arial,14'" << endl;
    gnuplot_links << "set label 21 at 0.5,0.15 'ω_{ср} = 1/0.0001 = 10000 рад/с' font 'Arial,14'" << endl;
    gnuplot_links << "set label 22 at 0.5,0.05 'Асимптотическая ЛАЧХ и ЛФЧХ строятся суммированием характеристик всех звеньев' center front font 'Arial,12'" << endl;
