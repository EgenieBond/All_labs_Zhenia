...
set output 'lach_plot.png'
set title 'Логарифмическая амплитудно-частотная характеристика (ЛАЧХ)'
...
plot 'bode_data.txt' using 1:2 with lines lw 3 lc rgb 'green' title 'ЛАЧХ'
